...
namespace Inance.Migrations
{
    ...
    [Migration("20241205222841_ServiceThumbnailNullabled")]
    partial class ServiceThumbnailNullabled
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inance.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Inance.Models.ServicePhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Inance.Models.AppUser", null)
                        .WithMany()
